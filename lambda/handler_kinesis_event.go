...
// NewHandlerKinesisEvent is used to process KinesisEvent types.
func NewHandlerKinesisEvent(handler func(context.Context, events.KinesisEvent) error) Handler {
	return lambdaHandler(func(ctx context.Context, payload []byte) (interface{}, error) {
		trace := handlertrace.FromContext(ctx)

		var e events.KinesisEvent
