...
// NewHandlerLexEvent is used to process LexEvent types.
func NewHandlerLexEvent(handler func(context.Context, events.LexEvent) (events.LexResponse, error)) Handler {
	return lambdaHandler(func(ctx context.Context, payload []byte) (interface{}, error) {
		trace := handlertrace.FromContext(ctx)

		var e events.LexEvent
