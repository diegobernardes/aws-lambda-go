...
// NewHandlerCognitoEvent is used to process CognitoEvent types.
func NewHandlerCognitoEvent(handler func(context.Context, events.CognitoEvent) error) Handler {
	return lambdaHandler(func(ctx context.Context, payload []byte) (interface{}, error) {
		trace := handlertrace.FromContext(ctx)

		var e events.CognitoEvent
